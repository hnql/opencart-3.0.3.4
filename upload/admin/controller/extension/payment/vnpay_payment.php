...
class ControllerExtensionPaymentVnpayPayment extends Controller {
	...
	if (isset($this->error['error_url'])) {
        ...
        //Merchant name
        if (isset($this->request->post[$classPrefix.'vnpay_payment_merchant'])) 
        {
            $data[$classPrefix.'vnpay_payment_merchant'] = $this->request->post[$classPrefix.'vnpay_payment_merchant'];
        }
        else 
        {
            $data[$classPrefix.'vnpay_payment_merchant'] = $this->config->get($classPrefix.'vnpay_payment_merchant');
        }
        //Terminal code
