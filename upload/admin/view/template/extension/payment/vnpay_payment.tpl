                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-vnpay_payment" class="form-horizontal">
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input type="text" style="width:100%;" name="vnpay_payment_merchant" value="<?php echo $vnpay_payment_merchant; ?>" placeholder="<?php echo $entry_merchant; ?>" id="input-merchant" class="form-control" />
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input type="text" style="width:100%;" name="vnpay_payment_secretkey" value="<?php echo $vnpay_payment_secretkey; ?>" placeholder="<?php echo $entry_secretkey; ?>" id="input-secretkey" class="form-control" />
